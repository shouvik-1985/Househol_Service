  ...
  <nav class="modern-navbar">
    <div class="nav-container">
      ...
      <div class="nav-links" :class="{ 'active': isMenuOpen }">
        <router-link to="/Servicedash/requests" class="nav-item">
          <i class="fas fa-clipboard-check"></i>
          <span>Requests</span>
        </router-link>
        <router-link to="/Servicedash/history" class="nav-item">
          <i class="fas fa-history"></i>
          <span>History</span>
        </router-link>
        <router-link to="/Servicedash/editProfile" class="nav-item">
...
export default {
  ...
  methods: {
    deletelocal() {
      ...
      localStorage.removeItem('service_Fullname');
    }
  },
  mounted() {
    const uname = localStorage.getItem('service_Fullname');
    const uid = localStorage.getItem('service_id');
    if (uname) {
